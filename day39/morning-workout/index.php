...
class Chihuahua extends Dog
{
    ...
    public function sit()
    {
        $this->position = "not going to sit while he smells Spartans";
        return "Sit, " . $this->name . "!";
    }
}
...
<?php $second_dog = new Chihuahua("BoneCrusher", ["Sparta Praha fans"]); ?>

<p>Chihuahua's name is <?= $second_dog->readDogTag(); ?></p>
<p>Chihuahua goes <?= $second_dog->barkAt("literally everything") ?> at Sparta Praha fans. </p>
