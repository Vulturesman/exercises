...
const chat = JSON.parse(conversation_json); // first parse

const conversationElem = document.querySelector(".conversation"); // select the place

chat.forEach((message, index) => {
  setTimeout(() => {
    conversationElem.innerHTML += `<div class="message message--${message.side}">
...
// const parsedConversation = JSON.parse(conversation_json);

// const displayConversation = () => {
//   const container = document.querySelector(".conversation");

//   parsedConversation.forEach((item) => {
//     const div = document.createElement("div");
//     container.appendChild(div);
//     if (item.side === "local") {
//       div.classList.add("message.message--local");
//     } else {
//       div.classList.add("message.message--remote");
//     }

//     const divMessage = document.createElement("div");
//     div.appendChild(divMessage);
//     divMessage.classList.add("message__text");
//     divMessage.innerText(${item.text});
//   });
// };
